...
int system_outputs_update(){
  ...
  int inputs__[] = {(int)status_entrada_0, (int)status_entrada_1, (int)status_entrada_2, (int)status_entrada_3, (int)status_entrada_4, (int)status_entrada_5, (int)status_entrada_6, (int)status_entrada_7, (int)status_entrada_8, (int)status_entrada_9};
  for(int i=0; i<10; i++){
    switch(i){
      case 0 : {
        for(int j = 0; j<10; j++){
